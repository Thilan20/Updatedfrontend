...
export default class Summary extends Component {  
  ...
  constructor(props) {  
    ...
    componentDidMount(){  
        debugger;  
        axios.get('https://localhost:5001/api/Modules?field=type&value=Core')  
          .then(response => {  
      ...
      return (  
        ...
        <div class="row justify-content-around">
         ...
         <h5> <strong><u>Level of Mapping</u></strong></h5>
          ...
          <h2 align="center"><strong>Core Modules Only</strong></h2></div></div>
           <br></br>
          ...
          <table className="table table-striped" style={{ marginTop: 10 }} id="table-to-xls1">   
            <thead>  
              <tr>  
                <th>CourseId</th>  
                <th>Name</th>  
